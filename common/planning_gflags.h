...
DECLARE_string(truck_config_path);
...
DECLARE_bool(enable_map_speed_limit);
...
DECLARE_double(fallback_longitudinal_jerk_lower_bound);
DECLARE_double(fallback_longitudinal_jerk_upper_bound);
...
DECLARE_double(crosswalks_speed_limit);
DECLARE_bool(enable_use_fake_obstacle_for_demo);
...
DECLARE_bool(enable_always_stop_pedestrian);
...
DECLARE_double(gradually_discreted_splice);
DECLARE_double(max_heading_error);
DECLARE_double(max_trailer_heading_error);
...
DECLARE_bool(print_path_bounder);
DECLARE_bool(print_log_parse_speed);
DECLARE_bool(print_log_parse_reference_line);

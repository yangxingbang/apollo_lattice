...
constexpr double kPathBoundsDeciderHorizon = 200.0;
...
constexpr double kPreviewTimeNonStaticObstacle = 10.0;
...
class PathBoundsDecider : public Decider {
 ...
 private:
  ...
  double lat_offset = FLAGS_replan_lateral_distance_threshold;
  ...
  double adc_theta_ = 0.0;
  double adc_speed_ = 0.0;

  double adc_trailer_l_to_lane_center_ = 0.0;
